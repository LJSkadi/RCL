    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <Link to="/" style={{ margin: '20px 20px' }} id="homeIcon"><FontAwesomeIcon icon="home" /></Link> {' '}
          {api.isLoggedIn() && <Tooltip placement="bottom" isOpen={this.state.tooltipOpenHome} target="homeIcon" toggle={(e) => this.toggle("tooltipOpenHome", e) }>Home</Tooltip>}
          {api.isLoggedIn() && <Link to="/search" style={{ margin: '20px 20px' }} id="searchIcon"><FontAwesomeIcon icon="search" /></Link>}{' '}
          ...
          {api.isLoggedIn() && <Link to="/host" style={{ margin: '20px 20px' }} id="bookIcon"><FontAwesomeIcon icon="book" /></Link>}{' '}
          ...
          {api.isLoggedIn() && <Link to="/bm" style={{ margin: '20px 20px' }} id="bookmarkIcon"><FontAwesomeIcon icon="bookmark" /></Link>}{' '}
          ...
          {api.isLoggedIn() && <Link to="/" style={{ margin: '20px 20px' }} id="signoutaltIcon" onClick={(e) => this.handleLogoutClick(e)}><FontAwesomeIcon icon="sign-out-alt" /></Link>}{' '}
